...
<html lang="en">
  ...
  <body>
    <div class="container">
        <h1 class="text-center mt-5">Edit Company Data</h1>
        <a class="btn btn-outline-danger rounded-pill btn-sm float-end" href="{{ route('company.index') }}">Back</a>
        ...
        <form action="{{route('company.update',$company->id) }}" method="POST" enctype="multipart/form-data">
            ...
            @method('PUT')
                ...
                <div class="mb-3 ">
                    ...
                    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ old('email',$company->email) }}" name="email">
                </div>
                <div class="mb-3 ">
